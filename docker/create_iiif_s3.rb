...
unless @csv_url = options[:manifest_file]
  ...
  begin
    ...
    # look for collection id with pattern, e.g., seq
    collection_id = csv_name.scan(/Seq/)[0]
...
opts[:output_dir] = "tmp"
opts[:variants] = { "reference" => 600, "access" => 1000}
...
opts[:image_types] = [".jpg", ".jp2", ".jpeg", ".tiff"]
